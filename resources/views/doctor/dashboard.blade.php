...
<div class="row mb-4">
    <div class="col">
        <h2><i class="fas fa-user-md"></i> Welcome, Dr. {{ $doctor->name }}</h2>
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="alert alert-info">
            <i class="fas fa-clock"></i> <strong>Working Hours:</strong> {{ $doctor->available_from }} - {{ $doctor->available_to }}
            <br>
            <i class="fas fa-calendar"></i> <strong>Working Days:</strong> 
            @php
